...
Per-repo orientation for `donaldgifford/champs`. This file is a
...
- Single binary under `cmd/champs/`; library code under
...
- Lives on Forgejo (`github.com/donaldgifford/champs`); a
